  ...
  const loadCheckout = async (priceId)=>{
    ...
    docRef.onSnapshot(async(snap)=>{
        ...
        if(sessionId){
            ...
            //init stripe
            const stripe =await loadStripe('pk_test_51MkVr0SHeZEwgcTrXGr1dQvPdzL3oxKkz5ztkC587gniNO6YI6Y5vLfbwMhOvYYdQsHpAg5zK5fgKE3unBBLLmYs00m2lt0TNE');
  ...
  return (
    <div className='PlansScreen'>
      ...
      {Object.entries(products).map(([productId , productData])=>{
        // TODD: add same lo9gic to check if user s subscription is active
